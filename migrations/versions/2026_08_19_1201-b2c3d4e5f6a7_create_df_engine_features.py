"""create df engine features

Revision ID: b2c3d4e5f6a7
Revises: a1b2c3d4e5f6
Create Date: 2026-08-19 12:01:00.000000

Renamed from the legacy df_engine_actions table (see a1b2c3d4e5f6 for
context on this squashed baseline).
"""
...
def downgrade() -> None:
    """Downgrade schema."""
    op.drop_table("df_engine_features")
