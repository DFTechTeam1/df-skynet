...
class ModelManagement:
    ...
    def list_conditions(
        ...
        *,
        ...
        the recovery view — only soft-deleted rows, availability ignored.
        """
        conditions: list[Any] = []
        if is_deleted:
            ...
            conditions.append(DfEngineModelOptions.is_available.is_(True))  # type: ignore
        if type:
    ...
    def action(self, record: dict[str, Any]) -> dict[str, bool]:
        ...
        return {
            ...
            "can_set_as_main": bool(record["is_enabled"]),
            "can_delete": (
