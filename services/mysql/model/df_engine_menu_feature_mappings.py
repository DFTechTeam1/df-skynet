...
class DfEngineMenuFeatureMappings(SQLModel, table=True):
    __tablename__ = "df_engine_menu_feature_mappings"  # type: ignore
    ...
    df_engine_features: Optional["DfEngineFeatures"] = Relationship(  # type: ignore
        back_populates="df_engine_menu_feature_mappings"
    )
    df_engine_menus: Optional["DfEngineMenus"] = Relationship(  # type: ignore
        back_populates="df_engine_menu_feature_mappings"
    )
