...
class DfEngineProjectSettings(SQLModel, table=True):
    ...
    updated_at: Optional[datetime] = Field(default=None, sa_column=Column(DateTime, nullable=True, onupdate=local_time))
    ...
    token_limit_threshold: Optional[float] = Field(default=None, sa_column=Column(Float, nullable=True))
