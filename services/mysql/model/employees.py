...
class Employees(SQLModel, table=True):
    ...
    education: Optional[EmployeeEducations] = Field(default=None, sa_column=Column(Enum(EmployeeEducations), nullable=True))
    ...
    user_id: Optional[int] = Field(default=None, sa_column=Column(BIGINT(unsigned=True), ForeignKey("users.id"), nullable=True))
