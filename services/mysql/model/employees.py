...
class Employees(SQLModel, table=True):
    ...
    martial_status: EmployeeMaritalStatuses = Field(
        sa_column=Column(Enum(EmployeeMaritalStatuses))
    )
    address: str = Field(sa_column=Column(String(255)))
    postal_code: Optional[str] = Field(
        default=None, sa_column=Column(String(6), nullable=True)
    )
    ...
    bank_detail: Optional[str] = Field(
        default=None, sa_column=Column(Text, nullable=True)
    )
    relation_contact: Optional[str] = Field(
        default=None, sa_column=Column(Text, nullable=True)
    )
    ...
    position_id: int = Field(
        sa_column=Column(BIGINT(unsigned=True), ForeignKey("position_backups.id"))
    )
    boss_id: Optional[int] = Field(
        default=None, sa_column=Column(Integer, nullable=True)
    )
    level_staff: Optional[str] = Field(
        default=None, sa_column=Column(String(255), nullable=True)
    )
    status: int = Field(sa_column=Column(SmallInteger))
    join_date: date = Field(sa_column=Column(Date))
    start_review_probation_date: Optional[date] = Field(
        default=None, sa_column=Column(Date, nullable=True)
    )
    probation_status: Optional[int] = Field(
        default=None, sa_column=Column(SmallInteger, nullable=True)
    )
    end_probation_date: Optional[date] = Field(
        default=None, sa_column=Column(Date, nullable=True)
    )
    bpjs_status: Optional[int] = Field(
        default=None, sa_column=Column(SmallInteger, nullable=True)
    )
    bpjs_ketenagakerjaan_number: Optional[str] = Field(
        default=None, sa_column=Column(String(50), nullable=True)
    )
    bpjs_kesehatan_number: Optional[str] = Field(
        default=None, sa_column=Column(String(50), nullable=True)
    )
    npwp_number: Optional[str] = Field(
        default=None, sa_column=Column(String(50), nullable=True)
    )
    bpjs_photo: Optional[str] = Field(
        default=None, sa_column=Column(String(255), nullable=True)
    )
    npwp_photo: Optional[str] = Field(
        default=None, sa_column=Column(String(255), nullable=True)
    )
    id_number_photo: Optional[str] = Field(
        default=None, sa_column=Column(String(255), nullable=True)
    )
    kk_photo: Optional[str] = Field(
        default=None, sa_column=Column(String(255), nullable=True)
    )
    ...
    resign_reason: Optional[str] = Field(
        default=None, sa_column=Column(String(255), nullable=True)
    )
    ...
    ptkp_status: Optional[str] = Field(
        default=None, sa_column=Column(String(5), nullable=True)
    )
    ...
    job_level_id: Optional[int] = Field(
        default=None, sa_column=Column(BigInteger, nullable=True)
    )
    avatar_color: Optional[str] = Field(
        default=None, sa_column=Column(String(255), nullable=True)
    )
    greatday_emp_id: Optional[str] = Field(
        default=None, sa_column=Column(String(100), nullable=True)
    )
    greatday_nationality: Optional[str] = Field(
        default=None, sa_column=Column(String(255), nullable=True)
    )
    greatday_job_grade: Optional[str] = Field(
        default=None, sa_column=Column(String(255), nullable=True)
    )
    greatday_marital_status: Optional[str] = Field(
        default=None, sa_column=Column(String(255), nullable=True)
    )
    greatday_cost_center: Optional[str] = Field(
        default=None, sa_column=Column(String(255), nullable=True)
    )
    greatday_employment_status: Optional[str] = Field(
        default=None, sa_column=Column(String(255), nullable=True)
    )
    greatday_work_location: Optional[str] = Field(
        default=None, sa_column=Column(String(255), nullable=True)
    )
    greatday_religion: Optional[str] = Field(
        default=None, sa_column=Column(String(255), nullable=True)
    )
    greatday_timezone: Optional[str] = Field(
        default=None, sa_column=Column(String(255), nullable=True)
    )
    greatday_shift_pattern: Optional[str] = Field(
        default=None, sa_column=Column(String(255), nullable=True)
    )
    greatday_job_status: Optional[str] = Field(
        default=None, sa_column=Column(String(255), nullable=True)
    )
    greatday_company: Optional[str] = Field(
        default=None, sa_column=Column(String(255), nullable=True)
    )
    employment_status_id: Optional[int] = Field(
        default=None, sa_column=Column(Integer, nullable=True)
    )
    is_phone_verified: Optional[int] = Field(
        default=None, sa_column=Column(SmallInteger, nullable=True)
    )

    position_backups: Optional["PositionBackups"] = Relationship(
        back_populates="employees"
    )  # type: ignore
    users: Optional["Users"] = Relationship(
        back_populates="employees", sa_relationship_kwargs={"uselist": False}
    )  # type: ignore
