...
class Users(SQLModel, table=True):
    ...
    email_verified_at: Optional[datetime] = Field(default=None, sa_column=Column(DateTime, nullable=True))
    password: str = Field(sa_column=Column(String(255)))
    image: Optional[str] = Field(default=None, sa_column=Column(String(255), nullable=True))
    last_login_at: Optional[datetime] = Field(default=None, sa_column=Column(DateTime, nullable=True))
    remember_token: Optional[str] = Field(default=None, sa_column=Column(String(100), nullable=True))
    ...
    employee_id: Optional[int] = Field(default=None, sa_column=Column(BigInteger, nullable=True))
    is_employee: Optional[int] = Field(default=None, sa_column=Column(SmallInteger, nullable=True))
    is_project_manager: Optional[int] = Field(default=None, sa_column=Column(SmallInteger, nullable=True))
    is_director: Optional[int] = Field(default=None, sa_column=Column(SmallInteger, nullable=True))
    reset_password_token_exp: Optional[datetime] = Field(default=None, sa_column=Column(DateTime, nullable=True))
    reset_password_token_claim: Optional[int] = Field(default=None, sa_column=Column(SmallInteger, nullable=True))
